  ...
  return (
    <div>
      ...
      <div className="slidessss opacity-100 min-h-screen flex items-center justify-center font-['Roboto']">
        <div className="bg-[#FFFFFF99] bg-opacity-90 p-24 rounded-lg shadow-lg z-[1] max-h-[614px] max-w-[564px]">
          <div className="flex flex-col slidesss items-center lg:-mt-20">
            <img src={Logo} alt="Logo" className="logo w-44 h-44" />
          </div>

          <h1 className="text-[24px] slides font-700 lg:w-[500px] lg:relative lg:right-16 font-[Manrope] text-[#42281B]">
            Welcome! to ROF's Self Scheduling Portal
          </h1>

          <div className="grid grid-cols-3 slidess gap-40 mb-3 lg:relative lg:right-[75px] lg:mt-10 cursor-pointer">
            <Link to="/Slide1">
